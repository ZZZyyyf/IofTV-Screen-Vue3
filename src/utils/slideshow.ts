export function showSlide(chart?: any, chartOption?: any, options?: any) {
  var defaultOptions = {
    interval: 2000,
    loopSeries: false,
    seriesIndex: 0,
  ...
  function autoShowTip() {
    function showTip() {
      // if (chartOption.series[0].data.length < 2) {
      ...
      var tipParams: any = { seriesIndex: seriesIndex }
      switch (chartType) {
        case 'map':
        case 'pie':
        case 'chord':
